        ...
        <header class="tranding_header header-layout">
            <div class=" header-layout_wrapper">
                <a href="#" class=" header-layout_link shaked-el" >
                    <span class="header-layout_linktext _anim-items">Тренды</span>
...
<path d="M4 12H20M20 12L16 8M20 12L16 16" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div class="tranding_content content-box">
            <div class="content-box_wrapper">
                <div class="content-box_featured featured-news">
                    <a href="#" class="featured-news_wrapper">
                        <header class="featured-news_header">
                            <div class="featured-news_imgbox">
                                <img src="<?php echo get_template_directory_uri() ?>/dist/images/family-dining.jpg" alt="image in featured card">
                            </div>
                        </header>
                        <div class="featured-news_content">
                            <div class="featured-news_title">
                                <h3>
                                    Удиви друзей новогодним меню
                                </h3>
                            ...
                            <div class="featured-news_description">
                                Готовьтесь к праздникам в стиле шеф-повара! Откройте нашу статью 'Удиви друзей новогодним меню', чтобы найти вдохновляющие и легкие рецепты, которые станут настоящим кулинарным трюком на вашем новогоднем столе!
                            </div>
                            <div class="featured-news_taxonomies">
                                <div class="featured-news_taxonomy">#Новый год</div>
                                <div class="featured-news_taxonomy">#Застолье</div>
                                <div class="featured-news_taxonomy">#Праздник</div>
                                <div class="featured-news_taxonomy">#Гости</div>
                            </div>
                        </div>
                    </a>
                </div>
                        ...
                        <div class="sidebar_news_wrapper">
                            <ul class="sidebar_news_list ">
                                <a href="" class="sidebar_news_item news-card">
                                    <div class="news-card_box">
                                        <div class="news-card_img">
                                            <img src="<?php echo get_template_directory_uri() ?>/dist/images/mayonnese.webp" alt="image in featured card">
                                        </div>
                                        <div class="news-card_content">
                                            <h4 class="news-card_title">
                                                Забудь про майонез! Ученые узнали...
                                            </h4>
                                            <div class="news-card_taxonomies">
                                                <div class="news-card_taxonomy">#Здоровье</div>
                                                <div class="news-card_taxonomy">#Похудание</div>
                                                <div class="news-card_taxonomy">#ПП</div>
                                            </div>
                                        </div>
                                ...
                                <a href="" class="sidebar_news_item news-card">
                                    <div class="news-card_box">
                                        <div class="news-card_img">
                                            <img src="<?php echo get_template_directory_uri() ?>/dist/images/shutterstock_338624465_2.jpg" alt="image in featured card">
                                        </div>
                                        <div class="news-card_content">
                                            <h4 class="news-card_title">
                                                Врач рассказал о вреде натуральных фрешей
                                            </h4>
                                            <div class="news-card_taxonomies">
                                                <div class="news-card_taxonomy">#Здоровье</div>
                                                <div class="news-card_taxonomy">#Похудание</div>
                                                <div class="news-card_taxonomy">#ПП</div>
                                                <div class="news-card_taxonomy">#Врач</div>
                                            </div>
                                        </div>
                                ...
                                <a href="" class="sidebar_news_item news-card">
                                    <div class="news-card_box">
                                        <div class="news-card_img">
                                            <img src="<?php echo get_template_directory_uri() ?>/dist/images/hurma-polza-vred.webp" alt="image in featured card">
                                        </div>
                                        <div class="news-card_content">
                                            <h4 class="news-card_title">
                                            ...
                                            <div class="news-card_taxonomies">
                                                <div class="news-card_taxonomy">#Здоровье</div>
                                                <div class="news-card_taxonomy">#Фрукты</div>
                                                <div class="news-card_taxonomy">#Похудание</div>
                                            </div>
                                        </div>
