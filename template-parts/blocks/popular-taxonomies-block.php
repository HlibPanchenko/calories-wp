...
$uniqid = uniqid('taxonomies-block-');
...
$popular_categories_background = $popular_categories["popular_categories_background"];
$popular_categories_title = $popular_categories["popular_categories_title"]; // text
$popular_categories_title_color = $popular_categories["popular_categories_title_color"]; // title color
$popular_categories_text_color = $popular_categories["popular_categories_text_color"];
...
<style>
    ...
    echo <<<EOT
    #$uniqid {
         background: $popular_categories_background;
         }
    
    #$uniqid .header-layout_linktext {
        color: $popular_categories_title_color;
    }
...
<section class="recipe-layout popular-taxonomies" id="<?php echo $uniqid; ?>">
    <div class="recipe-layout_container">
        <header class="recipe-layout_header header-layout">
            <div class=" header-layout_wrapper">
                <a href="<?php echo esc_url(home_url('/' . $popular_categories_link)); ?>"
                   class=" header-layout_link shaked-el">
                    <!--                <a href="-->
                    <?php //echo esc_url(get_permalink(get_page_by_path('recipes'))); ?><!--" class=" header-layout_link shaked-el" >-->
